// <copyright file="LinkBase.cs" company="Cimpress, Inc.">
...
namespace Tiger.Hal.Client
{
    ...
    {
        /// <summary>Initializes a new instance of the <see cref="LinkBase"/> class.</summary>
        /// <param name="isTemplated">
        /// A value indicating whether this link's href is a template which,
        ...
        /// <summary>
        /// Gets a value indicating whether this link's href is a template which,
        /// when bound, will be the location of the location of the target resource.
        /// </summary>
        ...
        /// <summary>
        /// Gets whether the link has been deprecated – that is,
        /// whether it will be removed at a future date.
        /// </summary>
        [CanBeNull]
